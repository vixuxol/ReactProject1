  ...
  return (
    <li className = {styles.card}>
      ...
      <div className = {styles.controls}>
        ...
        <svg width = "15" height = "15" viewBox="0 0 65 65" fill = "none">
	        <path d="M36.5,2.5h16c0.6,0,1-0.4,1-1s-0.4-1-1-1h-16c-0.6,0-1,0.4-1,1S35.9,2.5,36.5,2.5z" fill = "#D9D9D9"/>
          <path d="M56.5,2.5h2c0.6,0,1-0.4,1-1s-0.4-1-1-1h-2c-0.6,0-1,0.4-1,1S55.9,2.5,56.5,2.5z" fill = "#D9D9D9"/>
          <path d="M63.5,45.5c-0.6,0-1,0.4-1,1v7c0,0.6,0.4,1,1,1s1-0.4,1-1v-7C64.5,45.9,64.1,45.5,63.5,45.5z" fill = "#D9D9D9"/>
          <path d="M63.5,56.5c-0.6,0-1,0.4-1,1v1c0,0.6,0.4,1,1,1s1-0.4,1-1v-1C64.5,56.9,64.1,56.5,63.5,56.5z" fill = "#D9D9D9"/>
          ...
          <path d="M43.5,48.5V47l-4.7-3.5H21.5c-3.3,0-6-2.7-6-6v-15h-10c-2.2,0-4,1.8-4,4v22c0,2.2,1.8,4,4,4h8v9l12-9h14   C41.7,52.5,43.5,50.7,43.5,48.5z" fill = "#D9D9D9"/>
